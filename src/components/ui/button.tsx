  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-primary bg-background text-primary hover:bg-primary hover:text-primary-foreground shadow-md hover:shadow-lg transition-all",
        ...
        medical: "bg-gradient-to-r from-medical-primary to-medical-secondary text-white hover:shadow-glow shadow-md transition-all",
        success: "bg-success text-white hover:bg-success/90 shadow-md hover:shadow-lg transition-all",
      },
      size: {
